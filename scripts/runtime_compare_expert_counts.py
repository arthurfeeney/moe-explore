...
for file in files:
    ...
    melted_df = pd.melt(df, id_vars="num_experts", var_name="moe", value_name="time")
    seaborn.catplot(data=melted_df, x="num_experts", y="time", hue="moe", kind="bar", errorbar=None, legend_out=False)
